...
@section('content')
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['url'=>'sohotich', 'id' => 'create_sohotich', 'class'=>'horizontal-form']) !!}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="namso" id="namso" class="form-control">
                                            ...
                                            @for($i = $nam_start; $i <= $nam_stop; $i++)
                                                <option value="{{$i}}" {{$i == intval(date('Y')) ? 'selected' : ''}}>Năm {{$i}}</option>
                                            @endfor
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        {!!Form::number('sobatdau', 1, array('id' => 'sobatdau','class' => 'form-control required'))!!}
                                    </div>
                                </div>
                            </div>
                            <div class="row">
    ...
    <script type="text/javascript">
        function validateForm(){
            ...
            var validator = $("#create_sohotich").validate({
                rules: {
                    ten :"required"
                },
                messages: {
