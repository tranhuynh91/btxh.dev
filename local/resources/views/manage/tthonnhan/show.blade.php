        ...
        <div class="col-md-12">
            <div class="portlet box">
                <div class="portlet-title">
                    <h3 class="page-title">
                        Thông tin<small>&nbsp; tình trạng hôn nhân</small>
                    </h3>
                </div>
                <div class="portlet-body">
                    <div class="tabbable-line boxless">
                        <ul class="nav nav-tabs">
                            <li class="active">
                                <a href="#tab_1" data-toggle="tab">
                                    Thông tin xác nhận tình trạng hôn nhân</a>
                            </li>
                            <li>
                        ...
                        <div class="tab-content">
                            @include('manage.tthonnhan.include.tthonnhanprofile')
                            @include('manage.tthonnhan.include.thaydoiprofile')
                        </div>
                    </div>
                </div>
            </div>
