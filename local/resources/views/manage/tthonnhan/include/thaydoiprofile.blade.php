        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a href="{{url('thaydoibosung/tthncreate/'.$model->mahs)}}" class="btn btn-default btn-xs mbs"><i class="fa fa-plus"></i>&nbsp;Thêm mới</a>
                    </div>
                </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                            ...
                            @foreach($thongtinthaydoi as $key=>$tttd)
                                <tr>
                                    ...
                                    <td>
                                        <a>&nbsp;</a>
                                        <a href="{{url('thaydoibosung/printstokhaitdtthn/'.$tttd->id)}}" target="_blank" class="btn btn-default btn-xs mbs"><i class="fa fa-print"></i>&nbsp;Tờ khai</a>
                                        @if($tttd->trangthai == 'Chờ duyệt')
                                            <a href="{{url('thaydoibosung/showtthnbs/'.$tttd->id)}}" class="btn btn-default btn-xs mbs"><i class="fa fa-edit"></i>&nbsp;Chỉnh sửa</a>
                                        ...
                                        @else
                                            <a href="{{url('thaydoibosung/printstrichluctthnbs/'.$tttd->id)}}" target="_blank" class="btn btn-default btn-xs mbs"><i class="fa fa-print"></i>Bản sao</a>
                                            <a href="{{url('thaydoibosung/printstrichluctthnbc/'.$tttd->id)}}" target="_blank" class="btn btn-default btn-xs mbs"><i class="fa fa-print"></i>Bản chính</a>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
...
<div class="modal fade" id="duyet-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            {!! Form::open(['url'=>'thaydoibosung/tthnbs/duyet','id' => 'frm_duyet'])!!}
...
<div class="modal fade" id="delete-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            {!! Form::open(['url'=>'thaydoibosung/tthnbs/delete','id' => 'frm_delete'])!!}
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
