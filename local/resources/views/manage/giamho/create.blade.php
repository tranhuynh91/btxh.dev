...
@section('content')
    <h3 class="page-title">
        Thông tin đăng ký giám hộ<small> thêm mới</small>
    </h3>
    <div class="row">
        {!! Form::open(['url'=>'dangkygiamho','method'=>'post' , 'files'=>true, 'id' => 'create_hscb','class'=>'form-horizontal','enctype'=>'multipart/form-data']) !!}
