            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    @if($model->phanloainhap == "Giám hộ")
                        <input type="hidden" name="quyenhotich" id="quyenhotich" value="{{$model->soquyen}}">
                        <input type="hidden" name="sohotich" id="sohotich" value="{{$model->soso}}">
                        <input type="hidden" name="plbstrichluc" id="plbstrichluc" value="Giám hộ">
                    @elseif($model->phanloainhap == "Chấm dứt giám hộ")
                        <input type="hidden" name="quyenhotich" id="quyenhotich" value="{{$model->quyencd}}">
                        <input type="hidden" name="sohotich" id="sohotich" value="{{$model->socd}}">
                        <input type="hidden" name="plbstrichluc" id="plbstrichluc" value="Chấm dứt giám hộ">
                    @endif
                </div>
