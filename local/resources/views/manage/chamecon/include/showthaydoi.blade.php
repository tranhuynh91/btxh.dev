        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::model($model,['method' => 'post', 'url'=>'thaydoibosung/updatecmcbs/'.$model->id, 'id' => 'update_thaydoibosung', 'class'=>'horizontal-form']) !!}
            ...
            <div style="text-align: center">
                <a href="{{url('dangkychamecon')}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
