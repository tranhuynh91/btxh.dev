                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                            ...
                            @foreach($thongtinthaydoi as $key=>$tttd)
                                <tr>
                                    ...
                                    <td>
                                        <a>&nbsp;</a>
                                        <a href="{{url('thaydoibosung/printstokhaitdcmc/'.$tttd->id)}}" target="_blank" class="btn btn-default btn-xs mbs"><i class="fa fa-print"></i>&nbsp;Tờ khai</a>
                                        @if($tttd->trangthai == 'Chờ duyệt')
                                        ...
                                        @else
                                            <a href="{{url('thaydoibosung/printstrichluccmcbs/'.$tttd->id)}}" target="_blank" class="btn btn-default btn-xs mbs"><i class="fa fa-print"></i>Bản sao</a>
                                            <a href="{{url('thaydoibosung/printstrichluccmcbc/'.$tttd->id)}}" target="_blank" class="btn btn-default btn-xs mbs"><i class="fa fa-print"></i>Bản chính</a>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
