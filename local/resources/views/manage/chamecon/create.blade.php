...
@section('content')
    <h3 class="page-title">
        Thông tin đăng ký nhận cha mẹ con<small> thêm mới</small>
    </h3>
    <div class="row">
        {!! Form::open(['url'=>'dangkynhanchamecon','method'=>'post' , 'files'=>true, 'id' => 'create_hscb','class'=>'form-horizontal','enctype'=>'multipart/form-data']) !!}
        ...
        <div class="col-md-12">
                    ...
                    <div class="form-body">
                        <ul class="nav nav-pills nav-justified steps">
                            ...
                            <li><a href="#tab3" data-toggle="tab" class="step">
                                     <span class="badge badge-default">
                                        3 </span>
                                    <p class="description">Thông tin người nhận</p></a>
                            </li>
                            <li><a href="#tab4" data-toggle="tab" class="step">
                                     <span class="badge badge-default">
                                        4 </span>
                                    <p class="description">Thông tin được giám hộ</p></a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content">
                            @include('manage.chamecon.include.hoso')
                            @include('manage.chamecon.include.nguoikhai')
                            @include('manage.chamecon.include.nguoinhan')
                            @include('manage.chamecon.include.nguoiduocnhan')
                        </div>
                        <hr>
                        <div class="row">
            ...
            <div style="text-align: center">
                <a href="{{url('dangkynhanchamecon')}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
...
//B2
            ...
            if ( ok == false){
                ...
                if(strb3!='')
                    str+='Bước 3: Thông tin người nhận \n '+strb3 ;
                if(strb4!='')
                    str+='Bước 4: Thông tin người được nhận \n '+strb4 ;
