    ...
    <script>
        $(function(){
            $('#select_thang,#select_nam,#select_huyen, #select_xa').change(function() {
                var current_path_url = '/dangkynhanchamecon?';
...
@section('content')
    <h3 class="page-title">
        Danh sách thông tin<small>&nbsp;đăng ký nhận cha mẹ con</small>
    </h3>
    <!-- END PAGE HEADER-->
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="portlet box">
                ...
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        ...
                        <a href="{{url('dangkynhanchamecon/create')}}" class="btn btn-default btn-xs mbs"><i class="fa fa-plus"></i>&nbsp;Thêm mới</a>
                        @endif
                    </div>
                </div>
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_3">
                        ...
                        <tr>
                            ...
                            <th style="text-align: center" width="15%">Người đăng ký</th>
                            <th style="text-align: center" width="15%">Người nhận</th>
                            <th style="text-align: center" width="15%">Người được nhận</th>
                        ...
                        @foreach($model as $key=>$tt)
                            <tr>
                                ...
                                <td class="active">{{$tt->hotennk}}</td>
                                <td class="active">{{$tt->hotennn}}</td>
                                <td class="active">{{$tt->hotenndn}}</td>
                                ...
                                @endif
                                <td>
                                    <a href="{{url('dangkynhanchamecon/'.$tt->id.'/show')}}" class="btn btn-default btn-xs mbs"><i class="fa fa-eye"></i>&nbsp;Xem chi tiết</a>
                                    <a href="{{url('dangkynhanchamecon/'.$tt->id.'/printstokhai')}}" target="_blank" class="btn btn-default btn-xs mbs"><i class="fa fa-print"></i>&nbsp;Tờ khai</a>

                                        @if(can('dknhanchamecon','edit'))
                                    ...
                                    @if($tt->trangthai == 'Chờ duyệt')
                                        ...
                                        @endif
                                    @else
                                        <a href="{{url('dangkynhanchamecon/'.$tt->id.'/prints')}}" target="_blank" class="btn btn-default btn-xs mbs"><i class="fa fa-print"></i>&nbsp;In</a>
                                        <a href="{{url('dangkynhanchamecon/'.$tt->id.'/printsbansao')}}" target="_blank" class="btn btn-default btn-xs mbs"><i class="fa fa-print"></i>&nbsp;Bản sao</a>
                                    @endif
                                </td>
    ...
    <div class="modal fade" id="delete-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['url'=>'dangkynhanchamecon/delete','id' => 'frm_delete'])!!}
    ...
    <div class="modal fade" id="duyet-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['url'=>'dangkynhanchamecon/duyet','id' => 'frm_duyet'])!!}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
    ...
    <div class="modal fade" id="prints-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['url'=>'dangkynhanchamecon/prints','id' => 'frm_prints','target'=>'_blank'])!!}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
