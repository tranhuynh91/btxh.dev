        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="quyenhotich" id="quyenhotich" value="{{$model->quyen}}">
                    <input type="hidden" name="sohotich" id="sohotich" value="{{$model->so}}">
                    <input type="hidden" name="plbstrichluc" id="plbstrichluc" value="Khai sinh">
                </div>
