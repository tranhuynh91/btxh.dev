...
<html>
<head>
    <title>In giấy đăng ký giám hộ</title>
...
<table width="95%" border="0" cellspacing="0" cellpadding="4" style="border-collapse: collapse; margin: auto;text-align: center">
    <tr>
        <td><b>TỜ KHAI ĐĂNG KÝ GIÁM HỘ</b></td>
    </tr>
    <tr>
        <td colspan="3">Kính gửi: @if(session('admin')->level == 'H' && session('admin')->name == "Phòng tư Pháp huyện Đồng Văn")
...
<table width="95%" border="0" cellspacing="0" cellpadding="8" style="border-collapse: collapse; margin:20px auto">
    ...
    <tr>
        <td colspan="2"><b>Đề nghị cơ quan đăng ký việc giám hộ giữa những người có tên dưới đây:  </b></td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="2"><b>Lý do đăng ký giám hộ: {{$model->lydo}}</b></td>
    </tr>
    <tr>
        <td colspan="2">
