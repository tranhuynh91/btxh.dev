...
<table width="95%" border="0" cellspacing="0" cellpadding="8" style="border-collapse: collapse; margin:20px auto">
    ...
    <tr>
        <td colspan="3">Giấy tờ tùy thân:  {{$model->loaigiaytongh1}} số {{$model->sogiaytongh1}} do {{$model->noicapgtngh1}} cấp ngày {{getDayVn($model->ngaycapgtngh1)}}</td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="3">Giấy khai sinh/Giấy tờ tùy thân:  {{$model->loaigiaytondgh}} số  {{$model->sogiaytondgh}} do {{$model->noicapgtndgh}} cấp ngay</td>
    </tr>
    <tr>
        <td colspan="3">Nơi cư trú:  {{$model->tamtrutamvangndgh}}</td>
    </tr>
    <tr>
        <td colspan="3"><b>Đã đăng ký giám hộ tại:
    ...
    <tr>
        <td colspan="3">Số  {{$model->soqd}} ngày  {{getDayVn($model->ngaydangky)}}</td>
    </tr>
    <tr>
        <td colspan="3"><b>Ghi chú: {{$model->ghichu}}</b></td>
    </tr>
</table>
