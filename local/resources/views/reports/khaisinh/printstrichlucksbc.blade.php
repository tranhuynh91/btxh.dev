...
<table width="95%" border="0" cellspacing="0" cellpadding="8" style="border-collapse: collapse; margin:20px auto">
    <tr>
        <td colspan="3">Họ chữ đệm tên:{{$model->hotenntd}}</td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="3">Đã thực hiện ghi việc: {{$model->noidungtd}} </td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="3"><b>Nội dung ghi chú: {{$model->thaydoitu}} thành {{$model->thaydoithanh}}</b></td>
    </tr>
    <tr>
        <td colspan="3">Theo Giấy khai sinh số {{$khaisinh->so}} do {{$xa}} cấp ngày {{getDayVn($khaisinh->ngaydangky)}}</td>
    </tr>
</table>
